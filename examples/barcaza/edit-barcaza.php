    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Barcaza </a>
          </div>
      ...
      if ($id > 0) {
        ...
        if ($result->num_rows > 0) {
          ...
          echo "No se encontró la barcaza con el ID especificado.";
          exit();
        }
          ...
          <div class="col-md-12">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Editar Barcaza</h5>
              </div>
              <div class="card-body">
                <form>
                  <div class="row">
                    ...
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Nombre de Barcaza</label>
                        <input type="text" class="form-control" id="barcaza" value="<?php echo htmlspecialchars($row['nombre']); ?>">
                      </div>
                    </div>

                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>Tipo de Barcaza</label>
                        <input type="text" class="form-control" id="tipo_barcaza" value="<?php echo htmlspecialchars($row['tipo_barcaza']); ?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="empresa_barcaza" value="<?php echo htmlspecialchars($row['nombre_empresa']); ?>">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-3 pr-1">
                      <div class="form-group">
                        <label>Permiso SNE</label>
                        <input type="date" class="form-control <?php echo obtenerClaseFecha($row['permiso_SNE']); ?>" id="permisoSNE" value="<?php echo htmlspecialchars($row['permiso_SNE']); ?>">
                      </div>
                    </div>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>Exencion ACP</label>
                        <input type="date" class="form-control <?php echo obtenerClaseFecha($row['exencion_ACP']); ?>" id="exencion_acp" value="<?php echo htmlspecialchars($row['exencion_ACP']); ?>">
                      </div>
                    </div>
                    <div class="col-md-3 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Licencia AMP</label>
                        <input type="date" class="form-control <?php echo obtenerClaseFecha($row['licencia_AMP']); ?>" id="licencia_amp" value="<?php echo htmlspecialchars($row['licencia_AMP']); ?>">
                      </div>
                    </div>
                    <div class="col-md-3 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Patente de Navegacion</label>
                        <input type="date" class="form-control <?php echo obtenerClaseFecha($row['patente_de_navegacion']); ?>" id="patente_navegacion" value="<?php echo htmlspecialchars($row['patente_de_navegacion']); ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-3 pr-1">
                      <div class="form-group">
                        ...
                        <select class="form-control" id="ITC" name="ITC">
                          <option value="Cumple" <?php if ($row['ITC'] === 'Cumple') echo 'selected'; ?>>Cumple</option>
                          <option value="No cumple" <?php if ($row['ITC'] === 'No cumple') echo 'selected'; ?>>No cumple</option>
                        </select>
                      </div>
                    </div>
