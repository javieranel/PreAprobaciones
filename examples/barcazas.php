      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;"> Data Base Barcazas</a>
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Barcazas</h4>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarBarcaza">
                      Agregar Barcaza
                    </button>
                  </div>
                </div>

                <div class="modal fade" id="modalAgregarBarcaza" tabindex="-1" role="dialog" aria-labelledby="modalAgregarBarcazaLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="modalAgregarBarcazaLabel">Agregar Barcaza</h5>
                      ...
                      $categoria = 'barcaza'; // este debe coincidir con el valor guardado en tu BDD
                      ...
                      <div class="modal-body">
                        ...
                        <form id="formularioAgregarBarcaza">

                          <label for="nombre_new">Barcaza </label>
                          <input type="text" id="nombre_new" name="nombre_new" class="form-control" required>

                          <label for="tipo_barcaza_new">Tipo de Barcaza:</label>
                          <input type="text" id="tipo_barcaza_new" name="tipo_barcaza_new" class="form-control" required>
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="guardarBarcaza()">Guardar</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="table-responsive">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT id, nombre, tipo_barcaza, nombre_empresa, status FROM documentos WHERE categoria = 'Barcazas' ORDER BY nombre_empresa ASC";
                      ...
                      if ($result === false) {
                        ...
                        if ($result->num_rows > 0) {
                          ...
                          while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . htmlspecialchars($row['tipo_barcaza']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['nombre_empresa']) . "</td>";
                            echo "<td>" . htmlspecialchars($row['status']) . "</td>";
                            echo "<td><a href='../examples/barcaza/edit-barcaza.php?id=" . htmlspecialchars($row['id']) . "'><button class='btn btn-primary btn-edit' onclick='editarBarcaza(" . htmlspecialchars($row['id']) . ")'>EDITAR</button></a></td>";
                  ...
                  <div class="modal fade" id="modalDetalles" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Detalles de la Barcaza</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
