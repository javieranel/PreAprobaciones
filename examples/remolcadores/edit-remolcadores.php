    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Remolcadores</a>
          </div>
      ...
      if ($id > 0) {
        ...
        if ($result->num_rows > 0) {
          ...
          echo "No se encontró la Remolcadores con el ID especificado.";
          exit();
        }
          ...
          <div class="col-md-12">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Editar Remolcadores </h5>
              </div>
              <div class="card-body">
                <form>
                  <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 pr-1">
                        <div class="form-group">
                          <label>Licencia de Operación para Servicio de Remolcadores de la AMP</label>
                      ...
                      <div class="col-md-4 pr-1">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Certificate of Class (COC) </label>
                          <input type="date" class="form-control <?php echo obtenerClaseFecha($row['COC']); ?>"  id="COC" value="<?php echo htmlspecialchars($row['COC']); ?>">
                        </div>
                      </div>   

                      <div class="col-md-4 pr-1">
                        <div class="form-group">
                          <label for="exampleInputEmail1"> POLIZA DE PROTECCIÓN E INDEMNIZACIÓN</label>
                          <input type="date" class="form-control <?php echo obtenerClaseFecha($row['REMOL_POLIZA']); ?>"  id="REMOL_POLIZA" value="<?php echo htmlspecialchars($row['REMOL_POLIZA']); ?>">
                        </div>
                      </div>   
                    ...
                    <button type="button" class="btn btn-primary" onclick="guardarCambiosRemolcadores()">Guardar Cambios</button>
                    </div>
                </form>
