...
<script>
  function redireccionar() {
    window.location.href = 'http://localhost/control_permisos/examples/tanquero/tanquero_approved.php';
  }
</script>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;"> Data Base Tanquero</a>
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Tanqueros</h4>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarTanquero">
                      Agregar Tanquero
                    </button>
                  </div>
                  <div class="col-md-6">
                ...
                $categoria = 'tanquero'; // este debe coincidir con el valor guardado en tu BDD
                ...
                <div class="modal fade" id="modalAgregarTanquero" tabindex="-1" role="dialog" aria-labelledby="modalAgregarBarcazaLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="modalAgregarTanqueroLabel">Agregar Tanquero</h5>
                      ...
                      <div class="modal-body">
                        ...
                        <form id="formularioAgregarTanquero">

                          <label for="nombre_new">Tanquero </label>
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="guardarTanquero()">Guardar</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="table-responsive">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      $sql = "SELECT id, nombre, tipo_barcaza, nombre_empresa, status FROM documentos WHERE categoria = 'Tanqueros' ORDER BY nombre_empresa ASC";
                      ...
                      if ($result === false) {
                        ...
                        if ($result->num_rows > 0) {
                          ...
                          while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='../examples/Tanquero/edit-tanquero.php?id=" . htmlspecialchars($row['id']) . "'><button class='btn btn-primary btn-edit' onclick='editarBarcaza(" . htmlspecialchars($row['id']) . ")'>EDITAR</button></a></td>";
                          ...
                          echo "<tr><td colspan='3'>No se encontraron Tanqueros</td></tr>";
                        }
                      }
